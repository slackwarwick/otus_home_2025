...
public class ClientsWebServerWithBasicSecurity extends ClientsWebServerSimple {
    ...
    public ClientsWebServerWithBasicSecurity(
            int port, LoginService loginService, DBServiceClient serviceClient, Gson gson, TemplateProcessor templateProcessor) {
    ...
    protected Handler applySecurity(ServletContextHandler servletContextHandler, String... paths) {
        Constraint constraint = Constraint.from(ROLE_NAME_CLIENT, ROLE_NAME_ADMIN);
