...
public class WebServerWithBasicSecurity {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LoginService loginService = new InMemoryLoginServiceImpl(serviceClient); // NOSONAR

        ClientsWebServer clientsWebServer =
                new ClientsWebServerWithBasicSecurity(WEB_SERVER_PORT, loginService, serviceClient, gson, templateProcessor);
